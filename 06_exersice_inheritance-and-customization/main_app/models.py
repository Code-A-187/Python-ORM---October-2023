...
class BaseCharacter(models.Model):                  # Solution 1
...
class UserProfile(models.Model):                    # Solution 2
...
class Message(models.Model):
    ...
    def reply_to_message(self, reply_content: str, receiver: object):
        return Message(
...
class StudentIDField(models.PositiveIntegerField):                          # Solution 3
...
class MaskedCreditCardField(models.CharField):                    #  Solution 4
...
class Hotel(models.Model):                                # Solution 5
    name = models.CharField(
        max_length=100,
    )
...
class SpecialReservation(BaseReservation):
    ...
    def extend_reservation(self, days: int):
        # change the property is_available
