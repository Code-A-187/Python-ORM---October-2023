...
def show_all_authors_with_their_books() -> str:                            # Solution 1
    authors_with_books = []
...
def add_song_to_artist(artist_name: str, song_title: str) -> None:             # Solution 2
...
def calculate_average_rating_for_product_by_name(product_name: str) -> float:   # Solution 3
...
def calculate_licenses_expiration_dates() -> str:                        # Solution 4
...
def register_car_by_owner(owner: Owner) -> str:                         # Solution 5
