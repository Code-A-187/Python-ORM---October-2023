...
def create_pet(name: str, species: str):            # Solution 1
    Pet.objects.create(
        name=name,
        species=species)
...
def create_artifact(name: str, origin: str, age: int, description: str, is_magical: bool):  # Solution 2
...
def show_all_locations() -> str:                    # Solution 3
...
def apply_discount() -> None:                       # Solution 4
...
def show_unfinished_tasks() -> str:                          # Solution 5
...
def get_deluxe_rooms() -> str:                           # Solution 6
...
def update_characters() -> None:                            # Solution 7
