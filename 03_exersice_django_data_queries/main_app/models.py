...
class Pet(models.Model):                    # Solution 1
...
class Artifact(models.Model):               # Solution 2
    name = models.CharField(
        max_length=70
    )
...
class Location(models.Model):               # Solution 3
    name = models.CharField(
        max_length=100,
    )
...
class Car(models.Model):                    # Solution 4
...
class Task(models.Model):                       # Solution 5
...
class HotelRoom(models.Model):                         # Solution 6
    ROOM_TYPE_CHOICE = (
        ('Standard', 'Standard'),
        ('Deluxe', 'Deluxe'),
        ('Suite', 'Suite'),
...
class Character(models.Model):          # Solution 7
    CLASS_NAME_CHOICE = (
        ("Mage", 'Mage'),
        ('Warrior', "Warrior"),
        ('Assassin', "Assassin"),
