...
class Animal(models.Model):                 # Solution 1
...
class Employee(models.Model):                   # Solution 2
...
class ZooKeeper(Employee):
    ...
    def clean(self):                        # Solution 4
        super().clean()

        choices = [choice[0] for choice in self.SPECIALITIES]
...
class ZooDisplayAnimal(Animal):                    # Solution 3
    class Meta:
        proxy = True
    ...
    def display_info(self):                         # Solution 5
