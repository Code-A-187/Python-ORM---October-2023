...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main_app', '0002_remove_department_id_department_location_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, default=datetime.date(2023, 10, 26), null=True, verbose_name='Start Date')),
