...
class Customer(models.Model):                           # Solution 1
...
class BaseMedia(models.Model):                           # Solution 2
    class Meta:
        abstract = True
...
class Product(models.Model):                       # Solution 3
    name = models.CharField(
        max_length=100,
    )
...
class Hero(models.Model, RechargeEnergyMixin):              # Solution 4
    name = models.CharField(
         max_length=100,
     )
...
class Document(models.Model):                              # Solution 5
    title = models.CharField(
        max_length=200,
    )
